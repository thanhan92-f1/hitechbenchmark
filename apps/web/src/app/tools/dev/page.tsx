  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="flex items-center gap-3 mb-3">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{group.label}</h1>
      </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {group.tools.map((tool) => {
          ...
          return (
            <Link key={tool.id} href={tool.href} className={cn('group flex items-start gap-3 p-4 rounded-xl border bg-white dark:bg-gray-900 hover:shadow-sm transition-all', group.borderClass)}>
              ...
              <div>
                <span className="text-sm font-semibold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400">{tool.label}</span>
