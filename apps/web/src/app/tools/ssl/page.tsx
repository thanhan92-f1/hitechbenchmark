...
export default function SSLGroupPage() {
  const group = getToolGroup('ssl')!
        ...
        {group.tools.map((tool) => {
          ...
          return (
            <Link
              ...
              href={tool.href}
              className={cn(
                'group flex items-start gap-4 p-5 rounded-xl border bg-white dark:bg-gray-900 hover:shadow-sm transition-all',
                group.borderClass,
              )}
            >
