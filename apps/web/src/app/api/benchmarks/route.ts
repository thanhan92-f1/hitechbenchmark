...
const benchmarkPayloadSchema = z.object({
  ...
  system: z.object({
    ...
    cpu_temperature_c: z.number().min(-100).max(150).optional(),
    hypervisor_vendor: z.string().max(100).optional(),
    cloud_provider_detected: z.string().max(100).optional(),
    container_detected: z.boolean().optional(),
    cgroup_cpu_quota: z.string().max(100).optional(),
    cgroup_cpu_max: z.string().max(100).optional(),
    cgroup_memory_limit_mb: z.number().min(0).optional(),
    cgroup_cpu_shares: z.number().min(0).optional(),
  }),
  network: z.object({
  ...
  disk_results: z.array(
    z.object({
      ...
      disk_type: z.string().max(50).optional(),
      rotational: z.boolean().optional(),
      scheduler: z.string().max(100).optional(),
      smart_health: z.string().max(100).optional(),
      nvme_detected: z.boolean().optional(),
      nvme_model: z.string().max(255).optional(),
      nvme_namespace_count: z.number().int().min(0).optional(),
      ...
      fio_4k_qd1_read_iops: z.number().min(0).optional(),
      fio_4k_qd1_read_latency_ms: z.number().min(0).optional(),
      fio_4k_qd32_read_iops: z.number().min(0).optional(),
      fio_4k_qd32_write_iops: z.number().min(0).optional(),
      fio_4k_qd32_read_latency_ms: z.number().min(0).optional(),
      fio_4k_qd32_write_latency_ms: z.number().min(0).optional(),
      fio_seq_read_mbps: z.number().min(0).optional(),
      fio_seq_write_mbps: z.number().min(0).optional(),
    }),
  ).max(10),
  cpu_results: z.object({
    ...
    sevenzip_mips: z.number().min(0).optional(),
    gzip_mbps: z.number().min(0).optional(),
    openssl_sha256_mbps: z.number().min(0).optional(),
    openssl_aes256_mbps: z.number().min(0).optional(),
  }),
  memory_results: z.object({
    ...
    random_read_mbps: z.number().min(0).optional(),
    random_write_mbps: z.number().min(0).optional(),
  }),
  network_results: z.array(
    z.object({
      ...
      ip_version: z.string().max(20).optional(),
      test_type: z.string().max(50).optional(),
  ...
  security: z.object({
    ...
    firewall_name: z.string().max(100).optional(),
    ufw_status: z.string().max(100).optional(),
    ufw_rules_count: z.number().int().min(0).optional(),
    ...
    selinux_status: z.string().max(100).optional(),
    apparmor: z.boolean().optional(),
    apparmor_profile_count: z.number().int().min(0).optional(),
    fail2ban_installed: z.boolean().optional(),
    fail2ban_active: z.boolean().optional(),
    ssh_permit_root_login: z.string().max(100).optional(),
    ssh_password_authentication: z.string().max(100).optional(),
    kernel_lockdown: z.string().max(100).optional(),
  }),
})
