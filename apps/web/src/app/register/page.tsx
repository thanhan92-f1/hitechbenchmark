...
function OAuthButton({ provider, label }: { provider: string; label: string }) {
  ...
  return (
    <button
      type="button"
      disabled={loading}
      onClick={() => { setLoading(true); signIn(provider, { callbackUrl: '/dashboard' }) }}
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Join HiTech Benchmark</p>
        </div>
          ...
          <CardBody className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-2 bg-white dark:bg-gray-900 text-gray-400">or sign up with email</span>
              </div>
            </div>
